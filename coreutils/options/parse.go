...
func (o *OptionSet) parseArg() (bool, error) {
	...
	if fv, ok := option.Value.(boolFlag); ok && fv.IsBoolFlag() { // special case: doesn't need an arg
		if hasValue {
	...
	o.actual[name] = option
	return true, nil
}

// failf prints to standard error a formatted error and usage message and
// returns the error.
func (o *OptionSet) failf(format string, a ...interface{}) error {
