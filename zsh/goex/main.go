...
import (
	...
	// We need go-goon to be available; this ensures getting goex will get go-goon too.
...
func usage() {
	fmt.Fprintln(os.Stderr, `Usage: goex [flags] [packages] [package.]function(parameters)
...
func run(src string) error {
	...
	tempDir, err := ioutil.TempDir("", "goex_")
	if err != nil {
		return err
	}
	defer func() {
